...
rownames(nestlingGains_no_ctrl)<-1:nrow(nestlingGains_no_ctrl)

# checking for correlations in bill measurements.

nestlingGains_no_ctrl_dropNAs<-nestlingGains_no_ctrl[-c(19,20),]
cor(nestlingGains_no_ctrl_dropNAs$naresGain[-c(6:8)],nestlingGains_no_ctrl_dropNAs$widthGain[-c(6:8)])
cor(nestlingGains_no_ctrl_dropNAs$naresGain[-c(6:8)],nestlingGains_no_ctrl_dropNAs$depthGain[-c(6:8)])
cor(nestlingGains_no_ctrl_dropNAs$depthGain[-c(6:8)],nestlingGains_no_ctrl_dropNAs$widthGain[-c(6:8)])
